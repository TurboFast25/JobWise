...
*(z_score is 0.0 because this is Diego's first review — there is no prior distribution to normalize against.)*

---

## Step 3 — View Cookbook (`GET /api/v1/cookbook`)
...
*(Diego has not yet saved any recipes — the cookbook is empty before calling POST /cookbook.)*

---

## Step 4 — Save Recipe to Cookbook (`POST /api/v1/cookbook`)
...
## Step 5 — Verify Cookbook Updated (`GET /api/v1/cookbook`)
